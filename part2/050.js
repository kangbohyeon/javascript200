...
function RemovebleStorage() {
    Storage.call(this);
}
RemovebleStorage.prototype = Object.create(Storage.prototype);
RemovebleStorage.prototype.removeAll = function () {
    this.dataStore = {}
}
const productStorage2 = new RemovebleStorage();
